...
public class RegisterView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(250, 333));
        ...
        userTypeBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Patient", "Staff" }));
    ...
    private void passwordTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_passwordTextFieldActionPerformed
        // TODO add event for password text field
    }//GEN-LAST:event_passwordTextFieldActionPerformed

    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        if (this.isStaff()) {
            RegisterViewController.registerStaff(this.parseStaff());
        } else {
            RegisterViewController.registerPatient(this.parsePatient());
        }
    }//GEN-LAST:event_submitButtonActionPerformed

    private boolean isStaff() {
        //TODO Return true if user being registered is a staff member, else false
        return true;
    }

    private Patient parsePatient() {
        // TODO parse patient object from view and return
        
        /*
        CONSTRUCTOR SIGNATURE
        int ID, String firstName, String lastName, String username, 
        String password, int primaryCareProvider, float balance, 
        String email, String phoneNum, String insurance, Date birthDate
        
        If user is new, set ID to -1 so the database can autogenerate one.
        Discard object after inserting
        */
        Patient p = null;
        return p;
    }
    
    private Staff parseStaff() {
        // TODO parse staff member from view and return
        
        /*  
        CONSTRUCTOR SIGNATURE
        int ID, int accessLevel, String firstName, String lastName, 
        String username, String password, Date birthDate, Date hireDate
